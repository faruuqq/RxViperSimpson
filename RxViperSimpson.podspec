#
#  Be sure to run `pod spec lint RxViperSimpson.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Faruuq"
  # spec.authors            = { "Faruuq" => "faruuq.q@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Faruuq"
  ...
  spec.source       = { :git => "https://github.com/faruuqq/RxViperSimpson.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "RxViperSimpson/**/*.{swift}"
  ...
  spec.resources = "RxViperSimpson/**/*.{storyboard,xib}"
