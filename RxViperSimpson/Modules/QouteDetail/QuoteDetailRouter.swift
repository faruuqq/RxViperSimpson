...
class QuoteDetailRouter {
    ...
    public static func initialViewController(with data: QuoteDetailEntity?) -> QuoteDetailView {
        // TODO: HandleError if data: QuoteList is empty
        
        let interactor = QuoteDetailInteractor()
        let presenter = QuoteDetailPresenter(interactor: interactor, dataPassed: data ?? nil)
